import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import * as Vue from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/vue/index.mjs';
import { getCurrentScope, onScopeDispose, inject, computed, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowRef, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, ref, Suspense, Fragment, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, mergeProps, toRef, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/ofetch/dist/node.mjs';
import { g as baseURL } from '../_/nitro.mjs';
import { createHooks } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, getRequestURL, appendHeader, getRequestHeader, getCookie, setCookie, deleteCookie } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/vue-router/vue-router.node.mjs';
import { createDefu, defu } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery, parsePath, parseQuery, withoutTrailingSlash, isEqual as isEqual$1 } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/ufo/dist/index.mjs';
import { klona } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/klona/dist/index.mjs';
import { parse as parse$1 } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import destr from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/destr/dist/index.mjs';
import { isEqual } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/ohash/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/vue-devtools-stub/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/vue/server-renderer/index.mjs';
import { a as useSeoMeta$1, u as useHead$1, h as headSymbol } from '../_/renderer.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CA4JUmN0.mjs')
  },
  {
    name: "about___ca",
    path: "/ca/about",
    component: () => import('./about-D8F7yFBK.mjs')
  },
  {
    name: "about___es",
    path: "/es/about",
  ...
  },
  {
    name: "projects___ca",
    path: "/ca/projects",
    component: () => import('./projects-Ds4H-atI.mjs')
  },
  {
    name: "projects___es",
    path: "/es/projects",
  ...
  {
    name: "curriculum___ca",
    path: "/ca/curriculum",
    component: () => import('./curriculum-DfU5IMa1.mjs')
  },
  {
    name: "curriculum___es",
    path: "/es/curriculum",
    component: () => import('./curriculum-DfU5IMa1.mjs')
  },
  {
    name: "curriculum___en",
    path: "/en/curriculum",
    component: () => import('./curriculum-DfU5IMa1.mjs')
  },
  {
    name: "future-projects___ca",
    path: "/ca/future-projects",
    component: () => import('./future-projects-D-helkN-.mjs')
  },
  {
    name: "future-projects___es",
    path: "/es/future-projects",
    component: () => import('./future-projects-D-helkN-.mjs')
  },
  {
    name: "future-projects___en",
    path: "/en/future-projects",
    component: () => import('./future-projects-D-helkN-.mjs')
  }
];
  ...
  ca: [
    {
      ...
      load: () => import(
        './ca-B96sodHc.mjs'
        /* webpackChunkName: "locale_ca_46json_40ab4272" */
      ),
      cache: true
    }
  ],
  es: [
    {
      ...
      load: () => import(
        './es-C20aOtaA.mjs'
        /* webpackChunkName: "locale_es_46json_a5ba01c4" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        './en-DGQxdxSn.mjs'
        /* webpackChunkName: "locale_en_46json_3d8c5d26" */
      ),
      cache: true
    }
  ]
...
const vueI18nConfigs = [
  () => import(
    './i18n.config-D_U4Z2KS.mjs'
    /* webpackChunkName: "config_i18n_46config_46ts_34062747" */
  )
];
...
var define_I18N_LOCALE_HASHES_default$1 = { ca: "93b6f3dc", es: "93b6f3dc", en: "93b6f3dc" };
...
var define_I18N_LOCALE_HASHES_default = { ca: "93b6f3dc", es: "93b6f3dc", en: "93b6f3dc" };
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CneQPgth.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BJDFU-jx.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-5AexXo2w.mjs'));
...
export { _export_sfc as _, nuxtLinkDefaults as a, useI18n as b, useNuxtApp as c, useRouter as d, entry_default as default, encodeRoutePath as e, useRuntimeConfig as f, useSeoMeta as g, navigateTo as n, resolveRouteObject as r, useHead as u };
