...
import { $fetch as $fetch$1 } from "C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu, createDefu } from "C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, parsePath, parseQuery, withoutTrailingSlash, isEqual as isEqual$1 } from "C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/ufo/dist/index.mjs";
import { klona } from "C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/klona/dist/index.mjs";
import { parse as parse$1 } from "C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/destr/dist/index.mjs";
import { isEqual } from "C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/ohash/dist/index.mjs";
import { useSeoMeta as useSeoMeta$1, useHead as useHead$1, headSymbol } from "C:/Users/josaf/Desktop/Projectes/Portfolio/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CA4JUmN0.js")
  },
  {
    name: "about___ca",
    path: "/ca/about",
    component: () => import("./_nuxt/about-D8F7yFBK.js")
  },
  {
    name: "about___es",
    path: "/es/about",
  ...
  },
  {
    name: "projects___ca",
    path: "/ca/projects",
    component: () => import("./_nuxt/projects-Ds4H-atI.js")
  },
  {
    name: "projects___es",
    path: "/es/projects",
  ...
  },
  {
    ...
    path: "/ca/curriculum",
    component: () => import("./_nuxt/curriculum-DfU5IMa1.js")
  },
  {
  ...
  },
  {
    ...
    component: () => import("./_nuxt/future-projects-D-helkN-.js")
  },
  {
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CneQPgth.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BJDFU-jx.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-5AexXo2w.js"));
