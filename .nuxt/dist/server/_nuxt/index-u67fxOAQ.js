...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "grid gap-4 border-b border-slate-800 py-12" }, _attrs))}><h2 class="text-2xl font-semibold text-white">About me</h2><p class="max-w-4xl text-slate-300"> Sóc enginyer de sistemes AI i desenvolupador full stack orientat a construir solucions escalables, mantenibles i orientades a negoci. Tinc experiència en ecosistemes Laravel/Vue, integracions cloud i sistemes multiagent. </p></section>`);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_SocialLinks = _sfc_main$6;
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "grid gap-4 pt-12" }, _attrs))}><h2 class="text-2xl font-semibold text-white">Contacte</h2><p class="text-slate-300">Disponible per a projectes de desenvolupament web, consultoria AI i col·laboracions tècniques.</p>`);
  _push(ssrRenderComponent(_component_SocialLinks, null, null, _parent));
  _push(`</section>`);
}
...
//# sourceMappingURL=index-u67fxOAQ.js.map
