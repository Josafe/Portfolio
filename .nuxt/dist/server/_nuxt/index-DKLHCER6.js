import { mergeProps, useSSRContext, defineComponent, resolveComponent } from "vue";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const socialLinks = [
      ...
      {
        label: "LinkedIn",
        href: "https://www.linkedin.com/in/joan-sabater-ferré-2b4169115",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full min-w-0 space-y-8" }, _attrs))}><div class="rounded-[2rem] border border-white/10 bg-slate-900/80 p-5 sm:p-6 shadow-soft backdrop-blur-xl overflow-hidden"><div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"><div class="min-w-0"><p class="text-sm uppercase tracking-[0.11em] text-slate-400">Engineering Stack</p><h2 class="mt-3 text-lg font-semibold text-white">Modern architecture across every layer.</h2></div><div class="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-500/10 text-brand-200"><span class="text-sm font-semibold">→</span></div></div></div><div class="grid gap-5 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3"><!--[-->`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="relative mx-auto w-full max-w-7xl px-4 pb-16 pt-20 sm:px-6 sm:pb-20 sm:pt-24 lg:px-8 lg:pt-28">`);
      _push(ssrRenderComponent(_component_HeroSection, null, null, _parent));
      _push(`<section class="mt-16 grid gap-8 grid-cols-1 xl:grid-cols-[1fr_0.9fr]"><div class="space-y-6 min-w-0"><div class="w-full min-w-0 overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/70 p-5 sm:p-6 shadow-soft backdrop-blur-xl"><div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"><div class="min-w-0"><p class="text-sm uppercase tracking-[0.11em] sm:tracking-[0.14em] text-slate-400">Connect &amp; collaborate</p><h2 class="mt-3 text-2xl font-semibold text-white break-words">Connect with the core systems that shape premium digital products.</h2></div></div><div class="mt-6">`);
...
//# sourceMappingURL=index-DKLHCER6.js.map
