...
import { mergeProps, defineComponent, ref, withCtx, createTextVNode, unref, useSSRContext } from 'vue';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-slate-950 text-slate-100 antialiased" }, _attrs))}>`);
  _push(ssrRenderComponent(_component_Navbar, null, null, _parent));
  _push(`<main class="mx-auto w-[min(1120px,92vw)] py-10 sm:py-14 pt-24">`);
...
//# sourceMappingURL=default-CpvA7cKJ.mjs.map
