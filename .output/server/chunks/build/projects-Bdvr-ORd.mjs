...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid gap-8" }, _attrs))}><div class="grid gap-4"><h1 class="text-4xl font-bold text-white">Projectes</h1><p class="text-slate-400"> Una col\xB7lecci\xF3 de projectes desplegats i repositoris t\xE8cnics que mostren el meu treball en desenvolupament web i sistemes d&#39;IA. </p></div><div class="flex gap-1 rounded-lg border border-slate-800 p-1"><button class="${ssrRenderClass([
...
//# sourceMappingURL=projects-Bdvr-ORd.mjs.map
