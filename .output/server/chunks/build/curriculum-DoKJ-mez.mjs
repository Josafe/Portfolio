...
const curriculums = [
  {
    ...
    pdf: "public\\cv\\fullstack.pdf",
    preview: "public\\images\\cv\\fullstack-preview.svg",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid gap-12" }, _attrs))}><div class="grid gap-4"><h1 class="text-4xl font-bold text-white">Curriculum Vitae</h1><p class="text-slate-400"> Versions especialitzades del meu curr\xEDculum per diferents rols professionals. </p></div><div class="grid gap-8 lg:grid-cols-2"><!--[-->`);
      ssrRenderList(unref(curriculums), (cv) => {
        _push(ssrRenderComponent(_component_CVCard, mergeProps({
          key: cv.id
        }, { ref_for: true }, cv), null, _parent));
      });
      _push(`<!--]--></div><div class="rounded-lg border border-slate-800 p-6"><h3 class="text-lg font-semibold text-white mb-4">Informaci\xF3 Addicional</h3><div class="grid gap-4 text-sm text-slate-300"><p> Els curr\xEDculums inclouen experi\xE8ncia professional detallada, projectes destacats, tecnologies dominades i certificacions rellevants. </p><p> Disponible per a versions personalitzades segons requisits espec\xEDfics de posici\xF3 o empresa. </p></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=curriculum-DoKJ-mez.mjs.map
